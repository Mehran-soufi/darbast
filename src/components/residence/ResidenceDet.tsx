...
type Facilities =
  ...
  | "زمین بازی کودک"
  | "کنسول بازی";
const facilitiesIconsMap: Record<Facilities, React.ReactElement> = {
  استخر: <MdOutlinePool className="text-slate-500" />,
  "وای فای": <MdWifi className="text-slate-500" />,
  پارکینگ: <MdLocalParking className="text-slate-500" />,
  "زمین بازی کودک": <FaChild className="text-slate-500" />,
  "کنسول بازی": <MdOutlineSportsEsports className="text-slate-500" />,
};
interface ResidenceFacilitiesProps {
  facilities: string[];
}
        ...
        <div className="w-full h-full p-2 bg-gray-100 rounded-lg">
          ...
          <div className="w-full p-2 border-b border-gray-300">
            ...
            <div className="w-full flex items-center justify-start flex-wrap">
              {residence.facilities.map((item, index) => (
                <>
                  <div className="flex items-center gap-2" key={index}>
                    {facilitiesIconsMap[item as Facilities] || <span>?</span>}
                    <p>{item}</p>
                  </div>
                  {index < residence.facilities.length - 1 && (
                    <div className="px-1">
                      <span>-</span>
                    </div>
                  )}
      ...
      <div className="lg:col-span-1 col-span-2 p-2">
        <div className="w-full h-full p-2 bg-gray-100 rounded-lg">
          <div className="w-full">
            <div className="w-full flex p-2 border-b border-gray-300 gap-1">
              <IntlProvider locale="fa">
                <p className="text-xl text-gray-500">هرشب از </p>

                <p className="flex items-center gap-1 text-slate-900 text-lg">
                  <span>
                    <FormattedNumber value={residence.price} />
                  </span>
                  <span>
                    <svg
                      width="20"
          ...
          <div className="w-full p-2 border-b border-gray-300">
            <div className="w-full py-2">
              <p className="text-gray-500">ساعت ورود و خروج:</p>
            </div>
            <div className="w-full flex items-center justify-between flex-wrap">
              <div className="flex items-center gap-2">
                <ImEnter className="text-gray-500" />
                <p>ورود: 14</p>
              </div>
              <div className="flex items-center gap-2">
                <ImExit className="text-gray-500" />
                <p>خروج: 14</p>
              </div>
            </div>
          </div>
